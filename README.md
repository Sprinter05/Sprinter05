...
<div style="display: flex; flex-direction: row; gap: 10px">
    ...
    <picture> <img height="48" width="48" title="Python" src="https://skillicons.dev/icons?i=bash" /> </picture>&nbsp
...
- I also made a [yt-dlp](https://github.com/yt-dlp/yt-dlp) frontend made using **batch** scripts (**bash** scripts made by a friend also available), which aims to be compatible with any Windows version and Linux distribution. An android version might be made in the future.
...
- In the hardware side I'm building my own **homelab** where I'm hosting my different websites and services using [Docker Compose](https://docs.docker.com/compose/). I'm currently in the process of documenting what I can about it.
